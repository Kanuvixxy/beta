...
var timeMachine, timeMachineImg;
var time1, time2, time3, time4;
var t1Img, t2Img, t3Img, t4Img;
var puzzleImg1, puzzleImg2, puzzleImg3;
...
function draw() {
  ...
  if (gameState === 0) {
    ...
    text(
      "You are a caveman who has been teleported to the future.",
      windowWidth / 3 - 550,
      windowHeight / 2 + 90
    );
    text(
      "You have already collected some parts to build your time machine...",
      windowWidth / 3 - 550,
      windowHeight / 2 + 105
    );
    text(
      "You have to collect 4 more parts to return to your home(i.e. Egypt)",
      windowWidth / 3 - 550,
      windowHeight / 2 + 120
    );
    text("Objective:", windowWidth / 3 - 550, windowHeight / 2 + 155);
    text(
      "You need to collect 4 more parts of your time machine which appear",
      windowWidth / 3 - 550,
      windowHeight / 2 + 170
    );
    text(
      "The controls will be seen when you hit play",
      windowWidth / 3 - 550,
      windowHeight / 2 + 185
    );
    text(
      "But beware! There are zombies to stop you!",
      windowWidth / 3 - 550,
      windowHeight / 2 + 200
    );
    text(
      "Note: You have to keep the left mouse button pressed to shoot as it generates power",
      windowWidth / 3 - 550,
      windowHeight / 2 + 230
    );
    text(
      "The parts appear only after every 20 points...",
      windowWidth / 3 - 550,
      windowHeight / 2 + 245
    );
    text(
      "You get 5 points each for killing a zombie",
      windowWidth / 3 - 550,
      windowWidth / 2 + 260
    );
    text(
      "Some zombies are invincible so have to jump over them",
      windowWidth / 3 - 550,
      windowHeight / 2 + 275
    );
    textSize(30);
  ...
  if (gameState === 1) {
    ...
    fill("white");
    text("- Move Left", windowWidth / 19 - 10, windowHeight / 3 - 90);
    right.addImage("wide_putin", right_arr);
    fill("white");
    text("- Move Right", windowWidth / 19 - 10, windowHeight / 3 - 55);
    ...
    if (player.collide(time1)) {
      ...
      partSound.play();
      puzzleImg1 = createSprite(
        windowWidth / 3 + 170,
        windowHeight / 3 - 120,
        10,
        10
      );
      puzzleImg1.addImage("part1", t1Img);
    }
    ...
    if (player.collide(time2)) {
      ...
      part_count = part_count - 1;
      partSound.play();
      puzzleImg2 = createSprite(
        windowWidth / 3 + 240,
        windowHeight / 3 - 120,
        10,
        10
      );
      puzzleImg2.addImage("part2", t2Img);
    }
    ...
    if (player.collide(time3)) {
      ...
      part_count = part_count - 1;
      partSound.play();
      puzzleImg3 = createSprite(
        windowWidth / 3 + 255,
        windowHeight / 3 - 120,
        10,
        10
      );
      puzzleImg3.addImage("part3", t3Img);
    }
    ...
    if (player.collide(time4)) {
      ...
      part_count = part_count - 1;
      partSound.play();
      timeMachine = createSprite(windowWidth / 2, windowHeight / 2 - 100);
      timeMachine.addImage("part4", timeMachineImg);
    }
    createZombie();
